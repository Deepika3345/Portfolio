                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                        <div>
                            ...
                            <p className='slide-in-bottom'>
                                Worked as Full stack web developer intern at Eskills Web.<br></br>
                                The technology I've worked on : <span className="text-red ls-2">React js , Redux ,Node js ,Express js<br></br>
                                 mongooDB, Html5, Css, JavaScript, Bootstrap ,Material UI</span>
                            </p>
                            <p className='slide-in-bottom'>
