            ...
            <div className="p-4 slide-in-top">
                ...
                <div className="row">
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls1" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <div className="row d-flex justify-content-center">
                                ...
                                <a href="https://github.com/Deepika3345/Weather.git" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" ><AiFillGithub/> Source Code</a>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div>
                            <h5 className="ff-jose my-1">Shopping App</h5>
                            <div className="row d-flex justify-content-center">
                                ...
                                <a href="https://github.com/Yagnik-Gohil/MovieHunt" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" ><AiFillGithub/> Source Code</a>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls3" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <h5 className="ff-jose my-1">News App</h5>
                            <div className="row d-flex justify-content-center">
                                <a href="https://github.com/Deepika3345/Ab-tak-react.git" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" ><AiFillGithub/> Source Code</a>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls4" className="carousel slide my-1" data-bs-ride="carousel">
                            ...
                            <h5 className="ff-jose my-1">Crypto</h5>
                            <div className="row d-flex justify-content-center">
                                ...
                                <a href="https://github.com/Deepika3345/Crypto.git" className="col-sm-12 col-md-5 portfolio-link text-decoration-none text-white m-1 px-2 py-1 bg-blue rounded" ><AiFillGithub/> Source Code</a>
                            </div>
